...
val appModule = module {
    single { provideWallpaperPresenter() }
    single { provideOkHttpSSLBuilder() }
}

@NonNull
fun provideWallpaperPresenter(): WallpaperContract.Presenter = WallpaperPresenter(provideImagesStore())
